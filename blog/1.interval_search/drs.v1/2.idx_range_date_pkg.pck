  ...
  BEGIN
    ...
    p_debug('env.CURSORNUM: '||env.CURSORNUM);
        ...
        stmt2 := q'[INSERT INTO {index_tab_name} ( beg_date, end_date, rid )
            SELECT to_date(substr(P.{col_name}, 1,19),'YYYY-MM-DD HH24:MI:SS') as beg_date 
                  ,to_date(substr(P.{col_name},21,19),'YYYY-MM-DD HH24:MI:SS') as end_date 
                  ,P.rowid
