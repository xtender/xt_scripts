...
&_px   ,mon.proc_cnt
   ...
   ,mon.WORKAREA_MEM           as wa_mem
   ,mon.WORKAREA_MAX_MEM       as wa_max
   ,mon.WORKAREA_TEMPSEG       as wa_temp
   ,mon.WORKAREA_MAX_TEMPSEG   as wa_maxtemp
&_px   ,per_slave_rows
