...
accept v_low - 
		prompt 'Enter value for low value[yyyy-mm-dd hh24:mi:ss]: ';

accept v_high - 
		prompt 'Enter value for high value[yyyy-mm-dd hh24:mi:ss]: ';
...
BEGIN
   ...
   IF rec_srec.epc = 2 THEN
     ...
     dbms_output.put_line('Old low  value: '|| to_char(d_low,'yyyy-mm-dd hh24:mi:ss'));
     dbms_output.put_line('Old high value: '|| to_char(d_high,'yyyy-mm-dd hh24:mi:ss'));
     
     d_low  := to_date('&v_low' ,'yyyy-mm-dd hh24:mi:ss');
     d_high := to_date('&v_high','yyyy-mm-dd hh24:mi:ss');
     ...
     dbms_output.put_line('New low  value: '|| to_char(d_low,'yyyy-mm-dd hh24:mi:ss'));
     dbms_output.put_line('New high value: '|| to_char(d_high,'yyyy-mm-dd hh24:mi:ss'));
   ELSE
