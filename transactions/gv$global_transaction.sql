create or replace view gv$global_transaction as
SELECT 
      g."INST_ID"      "INST_ID"
     ,g."K2GTIFMT"     "FORMATID"
...
FROM   SYS.X$K2GTE2 g
/
create or replace view v$global_transaction as 
select FORMATID, GLOBALID, BRANCHID, BRANCHES, REFCOUNT, PREPARECOUNT, STATE, FLAGS, COUPLING
